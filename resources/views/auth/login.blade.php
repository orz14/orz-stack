...
@section('content')
    ...
    <main>
        ...
        @if (env('ENABLE_SOCIAL_LOGIN'))
            ...
            <div class="space-y-2">
                <x-button-link to="#" class="w-full bg-black hover:bg-slate-800 focus:bg-slate-800 active:bg-black">
                ...
                <x-button-link to="#" class="w-full bg-red-700 hover:bg-red-600 focus:bg-red-600 active:bg-red-700">
                    <span class="flex items-center gap-x-1">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5 fill-current">
